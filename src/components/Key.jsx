  ...
  render() {
    ...
    return (
      <div>
        ...
        <div onClick={this.sortPoints.bind(null, 'club')} id="club" className="key club">
          <span className="keyValue">
            <img src={clubUrl} alt="club" />
          </span>
          <span className="keyValue leftSpace">Tennis Club</span>
        </div>
        <div onClick={this.sortPoints.bind(null, 'court')} id="court" className="key court">
          <span className="keyValue">
            <img src={courtUrl} alt="court" />
          </span>
          <span className="keyValue leftSpace"> Public Tennis Court</span>
        </div>
        <div onClick={this.sortPoints.bind(null, 'shop')} id="shop" className="key shop">
          <span className="keyValue">
            <img src={shopUrl} alt="shop" />
          </span>
          <span className="keyValue leftSpace"> Tennis Shop</span>
        </div>
        <div onClick={this.sortPoints.bind(null, 'other')} id="other" className="key other">
          <span className="keyValue">
            <img src={otherUrl} alt="other" />
          </span>
          <span className="keyValue leftSpace"> Other Facility</span>
        </div>
        <div onClick={this.sortPoints.bind(null, 'all')} id="all" className="key all activeSort">
          <span className="keyValue">
